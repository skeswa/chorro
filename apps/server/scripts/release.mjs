...
/**
 * Prepares `@chorro/server` for deployment within a Kubernetes cluster:
 ...
 *    - Does nothing
 */
export function releaseChorroServer() {
  const logTag = `[${appsDirectoryName}/${serverAppDirectoryName}]`;
...
/** Invokes `releaseChorroServer` if this file was run directly. */
